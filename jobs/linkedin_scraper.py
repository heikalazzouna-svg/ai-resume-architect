...
class LinkedInScraper:
    ...
    def get_user_input(show_title=True):
        ...
        if show_title:
            ...
            st.html('<div class="linkedin-form">')
            st.html('<h3 class="linkedin-title"><i class="fab fa-linkedin"></i> LinkedIn Job Scraper</h3>')
            st.html('<p class="linkedin-subtitle">Find real-time job listings directly from LinkedIn</p>')
        ...
        with st.form(key='linkedin_scrape'):
            ...
            with col2:
                job_location = st.text_input(
                    ...
                    help="Enter a location or 'Tunisia' for nationwide search"
                )
    ...
    def scrap_company_data(driver, job_title_input, job_location):
        ...
        try:
            ...
            # Filter locations based on user input if provided and not "Tunisia"
            if job_location and job_location.lower() != "tunisia":
                filtered_locations = []
    ...
    def display_data_userinterface(df_final):
        ...
        # Display job count
        st.html(f'<div class="job-count">🎯 Found {len(df_final)} matching jobs on LinkedIn</div>')
        ...
        for i in range(len(df_final)):
            ...
            with st.expander("View Job Description"):
                ...
                st.html(f"<a href='{url}' target='_blank' class='job-url-button'>Apply on LinkedIn</a>")
