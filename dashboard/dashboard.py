...
class DashboardManager:
    ...
    def apply_dashboard_style(self):
        ...
        st.markdown("""
            <style>
                ...
                .metric-card {
                    background: linear-gradient(180deg, rgba(19, 34, 56, 0.92) 0%, rgba(14, 26, 43, 0.92) 100%);
                    border-radius: 20px;
                    padding: 1.5rem;
    ...
    def render_dashboard(self):
        ...
        st.markdown("""
            <style>
                .dashboard-container {
                    background: linear-gradient(135deg, rgba(10, 20, 35, 0.96) 0%, rgba(18, 34, 56, 0.96) 100%);
                    padding: 2rem;
                    border-radius: 20px;
                ...
                .section-title {
                    ...
                    border-bottom: 1px solid rgba(91, 225, 255, 0.2);
                }
                .chart-container {
                    background: rgba(19, 34, 56, 0.92);
                    border-radius: 16px;
                ...
                .trend-up {
                    background: rgba(107, 219, 168, 0.14);
                    color: #6bdba8;
                }
                .trend-down {
                    background: rgba(255, 123, 115, 0.14);
                    color: #ff7b73;
                }
                @keyframes fadeInUp {
                    from {
        ...
        for insight in insights:
            st.markdown(f"""
                <div class="insight-card">
                    <h3 style="color: #5be1ff; margin-bottom: 1rem; font-family: 'Fraunces', serif;">
